...
public class EmailServiceEN {
    ...
    public EmailServiceEN(WebClient.Builder webClientBuilder, ObjectMapper objectMapper) {
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate a response to the following mail. Do not generate a subject line, please. In english!!!");

        if (emailRequest.getUserInfo() != null && !emailRequest.getUserInfo().isEmpty()) {
            prompt.append("\nAditional info about the user: ").append(emailRequest.getUserInfo());
        }

        if (emailRequest.getTone() != null && !emailRequest.getTone().isEmpty()) {
            prompt.append("\nUse a tone: ").append(emailRequest.getTone());
        }
